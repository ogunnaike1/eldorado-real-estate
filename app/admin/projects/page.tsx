    ...
    <div>
      ...
      {projects.length === 0 ? (
        <div style={{ backgroundColor: "#fff", border: "1px solid #f0f0f0", padding: "60px 24px", textAlign: "center" }}>
          <p style={{ fontFamily: '"DM Sans", sans-serif', fontSize: "14px", color: "#a0aec0", marginBottom: "16px" }}>
            No projects yet. Add your first property listing.
          </p>
          <Link
            href="/admin/projects/new"
            style={{
        ...
        <div style={{ backgroundColor: "#fff", border: "1px solid #f0f0f0", overflow: "hidden" }}>
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "1fr 120px 100px 100px 140px",
              padding: "12px 20px",
          ...
          {projects.map((p) => (
            <div
              key={p.id}
              style={{ display: "flex", flexDirection: "column", padding: "16px 20px", borderBottom: "1px solid #f5f7fa" }}
            ...
            >
              ...
              <span style={{ fontFamily: '"DM Sans", sans-serif', fontSize: "12px", color: "#a0aec0", textTransform: "capitalize" }}>
                {p.category}
              </span>
              ...
              <span
                style={{
                  ...
                  fontSize: "11px",
                  fontWeight: 600,
                  color: p.status === "Selling" ? "#38a169" : p.status === "Sold Out" ? "#e53e3e" : "#a0aec0",
                  textTransform: "uppercase",
                  letterSpacing: "0.05em",
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  fontFamily: '"DM Sans", sans-serif',
                  fontSize: "12px",
                  color: p.published ? "#38a169" : "#a0aec0",
                }}
              >
                {p.published ? (
                  <>
