...
const slides = [
  { image: "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=1920&q=80", title: "Building Communities,\nNot Just Structures" },
  { image: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=1920&q=80", title: "Education Changes\nEverything" },
  { image: "https://images.unsplash.com/photo-1593113598332-cd288d649433?w=1920&q=80", title: "Empowering Lives\nAcross Nigeria" },
];
        ...
        <AnimatePresence mode="wait">
          <motion.div key={cur}>
            <motion.p initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0, transition: { delay: 0.3 } }} exit={{ opacity: 0 }}
              className="font-body text-[10px] sm:text-[11px] font-semibold tracking-megawide uppercase text-white/40 mb-5">
